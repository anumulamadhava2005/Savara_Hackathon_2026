          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <button
                ...
                disabled={isLoading}
                className="w-full bg-surface-container-lowest text-on-surface border border-surface-container-high py-4 rounded-[22px] font-bold text-[15px] flex items-center justify-center gap-3 hover:bg-surface-container-low transition-all active:scale-[0.98] ambient-shadow disabled:opacity-50"
              >
              ...
              <div className="flex items-center gap-4 py-2">
                ...
                <span className="text-on-surface-variant text-[10px] font-black uppercase tracking-widest">or use identity vault</span>
                <div className="h-[1px] flex-grow bg-surface-container-high"></div>
              </div>
